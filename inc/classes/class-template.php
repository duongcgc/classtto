...
class Template {
     ...
     */
    function ctto_load_default_template($file) {
     ...
     * @return bool True on success, false on failure.
     */
    function ctto_load_partial_file($partial) {
        ...
        if (!file_exists(CTTO_LAYOUT_PATH . $partial . '.php')) {
            return false;
        }

        require_once CTTO_LAYOUT_PATH . $partial . '.php';
     ...
     * @return void
     */
    function ctto_comment_callback($comment, array $args, $depth) {
